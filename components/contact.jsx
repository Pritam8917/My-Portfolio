...
export default function Contact () {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen bg-black text-white px-8 md:px-20 flex flex-col md:flex-row items-center gap-10  pt-30 relative "
    >
      {/* Left Image Section */}
      ...
      {/* Right Form Section */}
      <div className="w-full md:w-1/2 bg-white/5 p-10 sm:py-12 rounded-2xl shadow-lg border border-white/10">
